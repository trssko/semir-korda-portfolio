  ...
  return (
    <section id="skills" className="py-24 px-6 max-w-6xl mx-auto">
      <motion.div
        ...
        className="mb-14"
      >
        <p className="font-mono text-accent text-sm tracking-widest uppercase mb-2">{skills.label}</p>
        <h2 className="font-mono font-bold text-3xl md:text-4xl text-text">{skills.heading}</h2>
      ...
      >
        {skills.groups.map((group) => (
          <motion.div key={group.label} variants={item}>
            <p className="font-mono text-xs tracking-widest uppercase mb-4" style={{ color: group.color }}>
              {group.label}
            </p>
