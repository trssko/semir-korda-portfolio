export const translations = {
  en: {
    ...
    hero: {
      ...
      bio: 'Software engineering student from Sarajevo with hands-on experience in full-stack development, satellite mission control systems, and CI/CD pipelines.',
    ...
    skills: {
      ...
      groups: [
        ...
        { label: 'Backend', color: '#7c3aed', skills: ['Spring Boot', 'C#', 'ASP.NET Core', 'Java', 'Python', 'C++'] },
        { label: 'Databases', color: '#22c55e', skills: ['PostgreSQL', 'SQLite', 'MS SQL Server', 'Firebase'] },
        { label: 'DevOps & Tools', color: '#f59e0b', skills: ['Docker', 'GitLab CI/CD', 'Git', 'Linux/Bash', 'Postman'] },
        { label: 'Other', color: '#64748b', skills: ['Swagger', 'JIRA', 'Figma', 'XML', 'JSON', 'YAML'] },
      ],
    },
    projects: {
      label: '04. Projects',
      ...
      items: [
        ...
        },
        {
          ...
          description: 'This portfolio — built with React, Vite, and Tailwind CSS v4. Features bilingual support (EN/BS), light/dark mode, scroll-triggered animations, and a fully responsive layout.',
          tags: ['React', 'Vite', 'Tailwind CSS', 'Framer Motion'],
          github: 'https://github.com/trssko/semir-korda-portfolio',
          demo: null,
        },
        {
          title: 'FURAM — Car Rental Platform',
          description: 'UI/UX prototype for a full car rental platform covering browse, search with filters, vehicle detail with reviews, and a multi-step checkout flow with multiple payment methods.',
          tags: ['Figma', 'UI/UX', 'Prototyping'],
          github: null,
          demo: null,
          images: ['/furam-1.png', '/furam-2.png', '/furam-3.png', '/furam-4.png'],
        },
      ],
    },
    contact: {
  ...
  bs: {
    ...
    hero: {
      ...
      bio: 'Student softverskog inženjerstva iz Sarajeva s praktičnim iskustvom u full-stack razvoju, sistemima upravljanja satelitskim misijama i CI/CD pipelineima.',
    ...
    skills: {
      ...
      groups: [
        { label: 'Frontend', color: '#4f9eff', skills: ['JavaScript', 'TypeScript', 'Angular', 'HTML', 'CSS', 'Tailwind'] },
        { label: 'Backend', color: '#7c3aed', skills: ['Spring Boot', 'C#', 'ASP.NET Core', 'Java', 'Python', 'C++'] },
        { label: 'Baze podataka', color: '#22c55e', skills: ['PostgreSQL', 'SQLite', 'MS SQL Server', 'Firebase'] },
        { label: 'DevOps i alati', color: '#f59e0b', skills: ['Docker', 'GitLab CI/CD', 'Git', 'Linux/Bash', 'Postman'] },
        { label: 'Ostalo', color: '#64748b', skills: ['Swagger', 'JIRA', 'Figma', 'XML', 'JSON', 'YAML'] },
      ],
    },
    projects: {
      label: '04. Projekti',
      ...
      items: [
        ...
        {
          title: 'Lični portfolio website',
          description: 'Ovaj portfolio — izrađen s Reactom, Viteom i Tailwind CSS v4. Uključuje dvojezičnu podršku (EN/BS), svijetli/tamni mod, animacije pri scrollanju i potpuno responzivan dizajn.',
          tags: ['React', 'Vite', 'Tailwind CSS', 'Framer Motion'],
          github: 'https://github.com/trssko/semir-korda-portfolio',
          demo: null,
        },
        {
          title: 'FURAM — Platforma za rentanje auta',
          description: 'UI/UX prototip platforme za rentanje automobila s prikazom vozila, pretragom i filterima, detaljnom stranicom s recenzijama i višekoračnim procesom naplate s više metoda plaćanja.',
          tags: ['Figma', 'UI/UX', 'Prototyping'],
          github: null,
          demo: null,
          images: ['/furam-1.png', '/furam-2.png', '/furam-3.png', '/furam-4.png'],
